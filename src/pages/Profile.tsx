        ...
        <div className="flex flex-col">
          <div>
            <div className="mb-4">
              ...
              <input
                type="text"
                value={firstname}
                className="border border-gray-400 text-gray-500  bg-white rounded min-w-96   p-1  pr-96 "
                onChange={(e) => {
          ...
          <div>
            ...
            <div>
              ...
              >
                {isLoading  && !isChangePassword ? "Saving..." : "Save Changes"}
              </button>
            </div>
          </div>
          <div>
            ...
            <input
              type="password"
              className="border border-gray-400 text-gray-500 rounded  bg-white min-w-96    p-1 pr-96  "
              onChange={(e) => {
          ...
          >
            {isLoading && isChangePassword ? "Changing Password..." : "Change Password"}
          </button>
        </div>
      </div>
    </div>
